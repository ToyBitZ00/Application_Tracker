export default function DashboardPage() {
  return (
    <div className="px-8 pt-16 pb-32 max-w-4xl mx-auto">
      <p className="text-xs uppercase tracking-widest text-slate mb-4">Pipeline status</p>

      <h1 className="font-display text-3xl md:text-4xl leading-snug text-ink">
        You have{' '}
        <span className="font-mono font-semibold text-coral">12</span>{' '}
        active applications,{' '}
        <span className="font-mono font-semibold text-ink">3</span>{' '}
        awaiting reply, and{' '}
        <span className="font-mono font-semibold text-offer">1</span>{' '}
        offer pending.
      </h1>
